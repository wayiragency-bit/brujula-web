  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <aside className="glass-panel fixed top-4 bottom-4 left-4 z-40 hidden w-[108px] flex-col items-center py-2 rounded-2xl overflow-hidden lg:flex">
        ...
        {/* Nav icons */}
        <nav aria-label="Navegación principal" className="mt-12 flex flex-1 min-h-0 flex-col items-center justify-start gap-1.5 w-full px-2 overflow-y-auto">
        ...
        <button
          ...
          className="group flex flex-col items-center justify-center gap-1 rounded-xl py-2 px-4 transition-all duration-200 text-red-400 hover:bg-red-500 hover:text-white hover:shadow-[0_0_16px_rgba(239,68,68,0.3)]"
